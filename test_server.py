...
parser.add_argument('--test_dir',default='/home/Expirenment-Code/MIFT/data/test',type=str, help='./test_data')
parser.add_argument('--checkpoint', default='net_019.pth', type=str, help='save model path')
