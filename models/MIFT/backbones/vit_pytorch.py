...
class Multi_scale_transformer(nn.Module):
    r""" CrossFormer
...
def multiscale(**kwargs):
    model = Multi_scale_transformer(img_size=224, patch_size=[4, 8, 16, 32], in_chans=3, num_classes=1000,
                        embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24],
